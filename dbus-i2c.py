...
if python3:
	logging.info(__file__ + " is starting up - python 3")
else:
	logging.info(__file__ + " is starting up - python 2")
...
update()
# update every 3 seconds - temperature and humidity should move slowly so no need to demand
# too much CPU time
#
